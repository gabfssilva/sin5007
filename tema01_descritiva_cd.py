...
conjunto_de_dados = 'arquivos/dados/cursos_ies_2021_tecnologia_vf.CSV'

df = pd.read_csv('arquivos/dados/cursos_ies_2021_tecnologia_vf.csv',sep='|')
...
df.describe().to_csv('arquivos/dados/resumo_colunas.csv',sep='|')
